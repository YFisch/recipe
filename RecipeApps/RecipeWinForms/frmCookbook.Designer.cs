namespace RecipeWinForms
{
    partial class frmCookbook
    {
        ...
        private void InitializeComponent()
        {
            ...
            tblMain.RowCount = 7;
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 8.899291F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 8.899291F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 8.899291F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 13.348937F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 8.899291F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 8.782266F));
            tblMain.RowStyles.Add(new RowStyle(SizeType.Percent, 42.2716331F));
            ...
            lblCookbookName.Location = new Point(3, 70);
            ...
            lblPrice.Location = new Point(3, 192);
            ...
            lblActive.Location = new Point(3, 259);
            ...
            txtCookbookName.Location = new Point(136, 66);
            ...
            lstUserName.Location = new Point(136, 123);
            ...
            // txtDateCreated
            // 
            txtDateCreated.Location = new Point(369, 40);
            ...
            lblDateCreated.Location = new Point(369, 8);
            ...
            chbActive.Location = new Point(136, 263);
            ...
            // 
            btnSaveCookbookRecipe.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            btnSaveCookbookRecipe.AutoSize = true;
            btnSaveCookbookRecipe.Location = new Point(3, 316);
            ...
            gCookbookRecipes.Location = new Point(3, 353);
            gCookbookRecipes.Name = "gCookbookRecipes";
            gCookbookRecipes.RowTemplate.Height = 25;
            gCookbookRecipes.Size = new Size(866, 255);
            ...
            lblUser.Location = new Point(3, 124);
